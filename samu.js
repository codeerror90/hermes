...
console.log(chalk.greenBright("├"), chalk.keyword("magneta")("[ 🔋Nivel de carga de la vateria: ]"), chalk.greenBright(batterylevel+'%'), chalk.keyword("cyan")("Esta cargando?"), chalk.keyword("yellow")(charging))	
})
