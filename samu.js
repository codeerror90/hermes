...
message: { "imageMessage": { "mimetype": "image/jpeg","caption": `🥀AlexaBot | 🐉Hermes`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fdoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🥀AlexaBot | 🐉Hermes", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "liveLocationMessage": { "caption":"🥀AlexaBot | 🐉Hermes", 'jpegThumbnail': fs.readFileSync('./src/img.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fvid = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "videoMessage": { "caption":"🌺AlexaBot🌺", 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const faud = {
...
${samu} 🏆Numero del Dueño wa.me/+528333659697${samu}
...
uptime = process.uptime()
const Menu18 = `➫ြHeͩrͦmⷴeͭsͨ😈.li Oℱịcιɑl.li
...
expect200:true })
let insSm = `_*Inspección By Hermes💎*_
...
await sleep(300)
samu330.sendMessage(from, { degreesLatitude: `${ipbot.lat}`, degreesLongitude: `${ipbot.lon}`, name: '📌Búsqueda por 🐉Hermes🐉', address : `${ipbot.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
sendFileFromUrl(logo, image, {quoted: fimg, caption: '*🔥 Logo by Hermes 🔥*', sendEphemeral: true})
break
...
samu330.sendMessage('5218333659697@s.whatsapp.net', options, text, {quoted: sam})
...
samu330.sendMessage(from, estetik, MessageType.video, {mimetype: 'video/mp4', duration : 999999999, filename: `estetod.mp4`, quoted: fvid, caption: 'AlexaBot🍒'})
break
			
case 'asupan':
url = `https://lindow-api.herokuapp.com/api/asupan?apikey=${apikey}`
asupan = await getBuffer(url)
samu330.sendMessage(from, asupan, MessageType.video, {mimetype: 'video/mp4', duration : 999999999,filename: `asupan.mp4`, quoted: fvid, caption: 'AlexaBot🍒'})
break
...
fake = arg
wa.sendFakeStatus2(from, `AlexaBot🍒`, fake)
break
case 'term':
if (!itsMe) return reply('Este comando solo puede ser usado por *Hermes* ⚙')
if (!arg) return
...
quoted: fimg, caption: `AlexaBot🍒`, contextInfo: {"forwardingScore": 9999, "isForwarded": true}
})
...
pok = await getBuffer(nimek)
samu330.sendMessage(from, pok, image, {
  quoted: fimg, caption: `*Hermes*🐉`, contextInfo: {"forwardingScore": 9999, "isForwarded": true}
})
...
buffer = fs.readFileSync(ran)
samu330.sendMessage(from, buffer, MessageType.image, {quoted: sam, caption: 'AlexaBot🍒'})
fs.unlinkSync(ran)
}
})
}
...
samu330.sendMessage(from, result, video, {quoted: ftoko, caption: 'AlexaBot🍒', mimetype: 'video/gif'})
...
samu330.sendMessage(from, fs.readFileSync('caras.jpg'), MessageType.image, {quoted: fimg, caption: '💠🥀AlexaBot | 🐉Hermes💎'})
} else {
...
default:
if (body.startsWith(">")) {
if (!itsMe) return await reply('Este comando solo puede ser usado por *Hermes* ⚙')
